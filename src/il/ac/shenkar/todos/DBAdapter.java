...
public class DBAdapter
{
     ...
     * @return
     */
    public long insertTask(String title, String description, String date, String location, String important, String checkBoxState) 
    {
     ...
     * @return true - if update succeeded
     */
    public boolean updateTaskNotification(int id) 
    {
        ContentValues args = new ContentValues();
